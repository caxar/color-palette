...
const ContrastChecker = ({ data }) => {
  const bgWhite = colord(data).isReadable("#fff", {
    level: "AAA",
    size: "large",
  });
  const bgBlack = colord(data).isReadable("#000");
      ...
      <div className="contrast-wrapper">
        <div className="contrast-left">
          ...
          <div className="contrast-left__info" style={{ color: data }}>
            <div className="title">Example Headline (18px)</div>
        ...
        <div className="contrast-left">
          <div className="contrast-left__head">
            <div className="title">Black Background</div>
